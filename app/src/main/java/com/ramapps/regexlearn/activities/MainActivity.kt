...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadAppLanguage() {
        // Getting language settings and set it for android 12 and below.
        // In the Android 13+ this setting automatically (App language feature).
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            val langCode = getSharedPreferences(
                GlobalVariables.PREFERENCES_NAME_SETTINGS,
                MODE_PRIVATE
            ).getString(
